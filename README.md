...
| [`notebooks/qat.ipynb`](notebooks/qat.ipynb) | **QAT(양자화 인지 학습)** — fake quantization, STE(`autograd.Function`), PTQ vs QAT 비교 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/warpspaceinc/efficient-ml-practice/blob/main/notebooks/qat.ipynb) |
